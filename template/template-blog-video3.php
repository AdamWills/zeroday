                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 post-item <?php printf('%s',$cat_slug) ?>">
                                    ...
                                    <div class="tab-p-content">
                                        ...
                                        <div class="tab-p-desc">
                                            <span class="view"><?php filmmaker_setPostViews(get_the_ID()); ?> <?php $view = filmmaker_getPostViews(get_the_ID()); ?><?php echo esc_html($view); ?><?php esc_html_e('View','filmmaker'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php endwhile;
