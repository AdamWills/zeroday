                    ...
                    <ul class="relate-post">
                        ...
                        <li>
                            ...
                            <div class="titlemore col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <p class="status"><span><?php filmmaker_setPostViews(get_the_ID()); ?> <?php $view = filmmaker_getPostViews(get_the_ID()); ?><?php echo esc_html($view) ; ?> <?php esc_html_e('Views', 'filmmaker' ); ?></span></p>
                            </div>
                        </li>
                        <?php } ?>
                    </ul>
